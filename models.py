...
if __name__ == "__main__":
    # B, C, H, W, K = 1, 3, 256, 512, 3
    # input = paddle.randn([B, C, H, W], dtype="float32")
    # weight = paddle.randn([B, C, K, K, H, W], dtype="float32")
    # output = GuideConv.GuideConv(input, weight)
    # print(output)
    ...
    # x = paddle.randn([1, 3, 256, 256], dtype="float32")
    # w = paddle.randn([1, 3, 3, 3, 256, 256], dtype="float32")
    # y = model(x, w)
    # print(y)
